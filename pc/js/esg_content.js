...
cuckoo.init = function() {
	...
	$(window).load(function(){
		...
		let _stop_pos_esg = $("#esg-section01").offset().top;
	...
	$('.esg-s-track').slick({
		...
		customPaging : function(slick,i) {
			var _img = slick.$slides.eq(i).find('img').attr('src');
			var _i = i + 1;
			return '<div class="esg-thumb'+ _i +'" style="background-image:url('+ _img +')"></div>'
		}
	});
}
